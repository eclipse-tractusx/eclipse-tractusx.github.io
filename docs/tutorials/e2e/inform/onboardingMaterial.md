...
The [Catena-X Operating Model](https://catenax-ev.github.io/docs/operating-model/why-introduction) describes how the Catena-X data space is operated.
...
The [data integration pattern guide](https://catena-x.net/fileadmin/user_upload/04_Einfuehren_und_umsetzen/Onboarding/DataIntegrationPatterns_Guide_V1.1.pdf) gives an overview over the tasks and challenges associated with backend integration.
