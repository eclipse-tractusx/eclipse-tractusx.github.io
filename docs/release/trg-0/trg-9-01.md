...
- A KIT must have, at minimum, an adoption view (Sandbox stage) - see [KIT Maturity Levels](https://eclipse-tractusx.github.io/documentation/kit-lifecycle)
...
- A KIT must indicate its maturity level (sandbox, incubating, graduated) - see [KIT Maturity Levels](https://eclipse-tractusx.github.io/documentation/kit-lifecycle)
