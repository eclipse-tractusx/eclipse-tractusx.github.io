...
This explains each artifact a KIT can or must follow - depending on the graduation stage (TRG 8.02). An artifact is textual content or a technical component that is part of a KIT (e.g. a Vision statement).
