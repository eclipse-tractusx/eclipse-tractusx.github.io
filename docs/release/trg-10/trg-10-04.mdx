...
- The Graduation data is added to the [KIT master data](https://eclipse-tractusx.github.io/documentation/kit-master-data-overview) at the `graduationDate` field in the `maturity` section.
