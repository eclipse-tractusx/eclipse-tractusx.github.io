...
- The Masted Data structure must be respected, since it is used for autoomatization of the KIT webpage generation, for that automated checks are done in compilation time.
