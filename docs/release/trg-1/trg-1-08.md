...
- The interface documentation **should** be stored in the folder `/docs/api` as `openAPI.yaml`
...
- Alternative the interface documentation **should** be referenced in the .tractusx meta file as reachable document (like GitHub release asset)
