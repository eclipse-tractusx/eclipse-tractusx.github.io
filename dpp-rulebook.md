...
| 4.2.2   | Serial Value              | The value associated with the serial key.  | Optional | Recital (33) of Regulation (EU) 2024/1781 | - If provided, the attribute must describe the unique serial key. | String |
...
| 4.8.11  | Value (Environmental Footprint)| Provides numerical evaluation of environmental footprint, facilitating lifecycle sustainability assessments. | Yes       | Regulation (EU) 2024/1781, Article regarding environmental evaluations.                                | - Must be a valid, non-negative float. - Errors prompt documentation scrutiny.                                                          |           |
| 4.8.12  | Footprint Unit (Environmental Footprint)| Represents unit classification inherent to environmental footprint measures. | Yes       | Sustainability metric unit standardization described in documentation.                                | - Valid unit representation required for footprint context. - Errors result in metric validation warnings.                              |           |
| 4.8.13  | Footprint Type (Environmental Footprint)| Categorizes type of environmental impact for depth in sustainability analysis.| Yes       | Impact grouping taxonomy detailed, enhancing footprint categorization.                                | - Must explicitly match listed footprint type. - Deviations prompt documentation adjustments.                                          |           |
| 4.8.14  | Footprint Lifecycle (Environmental Footprint)| Identifies relevant lifecycle stage reflecting environmental footprint implications.| Yes       | Lifecycle transparency emphasized for ecological assessments.                                        | - Accurate lifecycle positioning required. - Errors result in overstated assessment warnings.                                           |           |
...
| 4.8.16  | Facility (Environmental Footprint)| Unique identifier for facility linked to environmental footprint production, enhancing transparency.| Yes       | Facility tracking described for sustainability aims.                                                  | - Coherent facility identifiers necessitated. - Errors relay exception signals.                                                           |           |
| 4.8.17   | Facility Address               | | | | | |
| 4.8.18  | Rulebook               | | | | | Document |
| 4.8.19  | Declaration               | | | | | Document |
| 4.8.20  | Value (Material Footprint) | Quantification of material footprint evaluates extraction demands for consumption. | Yes       | Material footprint analysis enunciated in sustainability regulations.                   | - Valid float metrics perceived as footprint necessity. - Errors dictate footprint examination modifications.                            |           |
| 4.8.21  | Footprint Unit (Material Footprint) | Unit classification aligns environmental impact evaluations with material metrics. | Yes       | Footprint measurement units standardized in validation chapters.     			       | - Valid unit representation supports methodological soundness. - Errors represent reassessment prerequisites.                            |           |
| 4.8.22  | Footprint Type (Material Footprint)| Impact categorization clarifies footprint implications within material contexts.| Yes       | Sustainability delineators guide footprint category distinctions.                                   | - Genuine categorization must adhere to specified impact types. - Errors initiate rectification undertakings.                            |           |
| 4.8.23  | Footprint Lifecycle (Material Footprint)| Details footprint lifecycle stage for material impact assessments, emphasizing ecodesign vigilance.     | Yes       | Lifecycle insight contextualized in sustainability regulations.                                      | - Lifecycle descriptions establish thematic compliance. - Absence necessitates accuracy confirmations.                       |           |
| 4.8.24  | Performance Class (Material Footprint)| Performance clarity matched within material contextual benchmarks.             | Yes       | Performance analysis captures material footprint efficacy.                                           | - Validated performance scale reliance suffices. - Missed descriptions preclude efficacy realizations.                                    |           |
| 4.8.25  | Facility Address               | | | | | |
| 4.8.26  | Rulebook               | | | | | Document |
| 4.8.27  | Declaration               | | | | | Document |
| 4.8.28  | Reparability Score                                                                             | Reparability indices foster restorative sustainability under regulatory constructs.                   | Yes       | Reparability parameters refine eco-centric directives.                                               | - Reparability categories normalize procedural reforms. - Errors reveal pragmatic reenhancements.                                         |           |
| 4.8.29  | Durability Score                                                                             | Durability scores endorse proactive preservation realms, uplifting eco-efficient designs.              | Yes       | Durability advancement enriches sustainable paradigms.                                               | - Valid durability cycles establish environmental worth. - Missed inputs generate anticipatory response mechanisms.                           |           |
| 4.8.30  | Reuse Info               | | | | | |
...
| Rule ID | Data Attribute | Data Attribute Description                                                                 | Mandatory/Optional | Regulatory Reference                                                                                   | Validation/Verification Rule                                                                                        | Data Type |
|---------|--------------|-----------------------------------------------------------------------------|-----------|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|-----------|
| 4.11.1  | Description  | Provides contextual information about the attribute, allowing for additional data transfer in future regulatory changes and updates. | Yes       | Regulation (EU) 2024/1781, facilitating the inclusion of specific information required by Union legislation within the digital product passport. | - Must provide a clear and concise description of the attribute. - Missing information results in validation errors.                                  |           |
| 4.11.2  | Label        | Human-readable name of the attribute, assisting in identification and user interaction. | Yes       | Labeling practices for promoting clarity in product data presentation.                                 | - Must specify a readable label for the attribute. - Errors or missing labels prompt user interface corrections.                           |           |
| 4.11.3  | Type Unit    | Complex description of the type, helping define unit characteristics or indicating empty if the "children" property is used. | No        | Unit specification practices as seen in product attribute descriptions.                               | - Must select appropriate unit type or indicate empty when "children" are specified. - Errors trigger type adjustment reviews.           |           |
| 4.11.4  | Data Type    | Specifies the data type, dictating attribute structure; if "object" is selected, children are utilized instead of data. | Yes       | Data structuring required for accurate attribute definition within digital systems.                    | - Must conform to specified data types under regulations. - Errors necessitate structure reassessment.                                  |           |
| 4.11.5  | Data         | Content of the attribute, dependent on data type and unit specifications. | No        | Data documentation practices underpinning product attribute logic.                                    | - Must align content with data type and unit dependency. - Errors signal content reevaluation.                                         |           |
| 4.11.6  | Children     | Children elements of the hierarchical structure, extending attribute definitions. | No        | Hierarchy management fostering complex attribute relationship documentation.                           | - Structure must enable hierarchical definitions as necessary. - Errors involve structure validation restructuring.                     |           |
```
