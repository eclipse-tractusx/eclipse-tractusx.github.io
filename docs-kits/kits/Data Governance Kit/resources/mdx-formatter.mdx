...
- url: https://dgk.cx.dev.dih-cloud.com
  ...
  parameters: - name: assetId
  in: path
  required: true
  schema:
  type: string - name: connectorUrl
  in: header
  required: false
  schema:
  type: string
  ...
  required: - apiKeyValue - id - name - url
  type: object
  properties:
  id:
  type: string
  ...
  example: - resourceId: asset1
  resourceType: asset
  targetEdcUrls: - http://test.url/1 - resourceId: asset2
  resourceType: asset
  targetEdcUrls: - http://test.url/2
  ...
  syncStatus:
  type: string
  enum: - syncing - in sync - out of sync - not published
