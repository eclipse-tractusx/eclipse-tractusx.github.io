...
![ESS_KitBlockDiagram](@site/kits/ESS-Kit/assets/CatenaX_ESS_KitBlockDiagram.png)
...
![ESS_KitSequenceView](@site/kits/ESS-Kit/assets/CatenaX_ESS_KitSequenceView.svg)
