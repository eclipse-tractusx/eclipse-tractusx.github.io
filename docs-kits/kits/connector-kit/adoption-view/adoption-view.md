...
- Connector: Is the common term for a technical component that is formally named (dataspace) participant agent, see [CX-0018][CX0018] for reference. It provides central features needed to act as data provider or consumer within the Catena-X dataspace.
...
![Basic Service Interaction](./artifacts/connector_interactions.drawio.png)
