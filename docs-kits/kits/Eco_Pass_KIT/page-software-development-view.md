...
| ------ | ------ | -------------------------------------------------- | ------------------------------------------ |
| Discovery Service  | POST   | /api/administration/connectors/discovery/search    | key:ManufactureID                          |
| BPN Discovery Service  | POST   | /api/administration/connectors/bpnDiscovery/search | key:ManufactureID                          |
| EDC Discovery Service   | POST   | /api/administration/connectors/discovery/search    | `{[<Company's BPNL>]}`                     |
| Digital Twin Registry  | GET    | /lookup/shells                                     | key:partInstanceID, value: batteryDMC-Code |
