...
|AI service|In general refer to Web API base services related with AI. This can be API to the LLM to the interface of protocol like A2A and MCP. A service that provides users with functionalities and/or value through the use of AI systems|this KIT|
