...
|------------|---------|---------|------|
| io.catenax.generic.digital_product_passport | 6.1.0 | This model shall address the basic | [Link](https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.generic.digital_product_passport/6.1.0) |
