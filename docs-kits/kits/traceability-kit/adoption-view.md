...
Data, no matter what discipline, which is important to reveal the root cause and all vehicles or components/batches which are affected shall be linked to this DT. 
