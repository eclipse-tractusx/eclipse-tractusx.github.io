...
Data, no matter what discipline, which is important to reveal the root cause and all vehicles (for the DT at the OEM) or components/batches (for the DT at the TierN) which are affected shall be linked to this DT. 
