...
Data provisioning of Traceabilty is built on the data provisioning of the [Industry Core KIT](../industry-core-kit/Architecture%20View%20industry-core-kit), i.e., Traceability extends the digital twins PartType and PartInstance with additional aspect models:
...
Details about these aspect models, i.e., the SAMM data model as well as example data, can be found in the [Developer View](../traceability-kit/software-development-view/data-provider-development-view).
...
Implementation details and examples can be found [in the Industry Core KIT](../industry-core-kit/software-development-view/policies-development-view).
