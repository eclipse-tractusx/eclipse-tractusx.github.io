...
### Changed
 - **Architecture View:**
  - Adapted process for sending, recieving and updating Block Notifications including Problem ID to refernce the Block Notification to the inital problem, the Block Notification was requested for
- **Development View:**
  - **App Provider:**
