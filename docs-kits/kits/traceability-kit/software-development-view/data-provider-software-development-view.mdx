---
id: data-provider-development-view
title: Data Provider
description: "Traceability Kit"
sidebar_position: 1
---

import AspectModels from './parts/aspect-models.mdx'
...
Access policies like the BPN access policy and Usage Policies / Contract Policies are described in the [policy section of the Industry Core KIT](../../industry-core-kit/software-development-view/policies-development-view).
