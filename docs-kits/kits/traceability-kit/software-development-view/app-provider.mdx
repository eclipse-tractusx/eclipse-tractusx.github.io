...
- [Block Notification API (v2.0.0)](https://github.com/anneramsauer/eclipse-tractusx.github.io/blob/main/openApi/traceability/kit_traceability-notifications-openAPI_2-0-0.yaml) 
