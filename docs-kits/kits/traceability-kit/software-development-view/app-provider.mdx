...
- [Block Notification API (v2.0.0)](https://github.com/anneramsauer/eclipse-tractusx.github.io/blob/main/docs-kits/kits/traceability-kit/openapi/block-notifications_2-0-0.yaml) 
