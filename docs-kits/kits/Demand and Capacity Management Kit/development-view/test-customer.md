...
This page lists all the tests that can be executed by the business role customer.
...
| Customer: Create IdBasedRequestForUpdate                                                                            | UUID_CG1  | {UUIDv4 that gets generated by the supplier. Known to the customer as soon as he consumes the corresponding WeekBasedCapacityGroup.}                           |
...
The customer compares the demand data, he sent to the supplier, to the capacity data, he received from the supplier.
...
Scenario: Consume valid  IdBasedRequestForUpdate
  ...
  Then I should be able to consume it, send my supplier a http 200 status message and provide my supplier with the data he requested, if applicable
```
