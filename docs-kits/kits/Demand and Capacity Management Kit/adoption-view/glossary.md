...
|API|Application Programming Interface is a set of rules, protocols, and tools for building software and applications. Examples for DCM can be found here: https://eclipse-tractusx.github.io/docs-kits/next/kits/DCM-Kit/development-view/overview#apis-utilized-by-a-dcm-application|
|Aspect Model|see: https://catenax-ev.github.io/docs/next/standards/CX-0002-DigitalTwinsInCatenaX#aspect-model|
...
|Business Partner Number Legal Entity (BPNL)|See: https://catenax-ev.github.io/docs/next/standards/CX-0010-BusinessPartnerNumber#153-legal-entity|
|Business Partner Number Site (BPNSL)|See: https://catenax-ev.github.io/docs/next/standards/CX-0010-BusinessPartnerNumber#154-site|
...
|Customer|A role within the DCM use case, which represents a company that receives goods from its suppliers. Participating companies can have multiple roles at the same time: in this context, A customers provides consistent and up-to-date demand forecast to and receives capacity data from suppliers. Synonymous: one-up.|
...
|Digital Twin|See: https://catenax-ev.github.io/docs/next/standards/CX-0002-DigitalTwinsInCatenaX#digital-twin|
...
|Nesting|A method by which a capacity group links to another capacity group (instead to material demand series), allowing for dynamic changes and centralized data management. See also: linking material demand. Synonymous: indirect linking|
|One-down|Used in DCM context as synonymous of “supplier”|
|One-up|Used in DCM context as synonymous of “customer”|
...
|Supplier|A role within the DCM use case, which represents a company that supplies goods to its customers. Participating companies can have multiple roles at the same time. Suppliers provide consistent and up-to-date capacity data and receive demands from customers. Synonymous: one-down.|
|Surplus|A surplus is a situation in which an oversupply exists. In the DCM context, it is often used to indicate a situation in which unutilized capacity exists. It is the contrary of a bottleneck. Synonymous: idle capacity, excess capacity.|
