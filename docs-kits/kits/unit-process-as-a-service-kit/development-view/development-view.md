...
[here](../sample-data/wafer_sample.json).

The changelog for the EDC interactions during the demonstration, including catalog requests, contract negotiations, and data transfers, is documented in the [EDC Exchange Log](../sample-data/edc-exchange-log.md). 
