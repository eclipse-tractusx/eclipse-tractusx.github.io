...
- There is a complete setup of the Catena-X dataspace available with all Core Services as defined by the Operating
  Model Whitepaper for R24-03.
- All users have **completed onboarding** to the Catena-X network. This includes:
    ...
    - Data Providers operate a Digital Twin Registry according to
      the [Digital Twin Kit](../Digital Twin Kit/page_adoption-view.md)
...
The Interoperability Layer the Industry Core Standards builds on, defines API structures of Data Providers and relevant
