...
CataloguePart represents an item in the Catena-X Bill of Material (BOM) in As-Planned lifecycle status in a specific version.

Aspect model in GitHub: 
- Version 1.0.0: https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.part_as_planned/1.0.1
- PartAsPlanned, Version 1.0.1: 
  - Deprecated - Successor version is CataloguePart, Version 1.0.0
  - https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.part_as_planned/1.0.1

#### Example: Aspect Model `CataloguePart` for a part type
...
Aspect model in GitHub: 
- Version 1.0.1 (Deprecated - Successor version is CataloguePart, Version 1.0.0):  https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.part_as_planned/1.0.1

#### Example: Aspect Model `PartAsPlanned` for a part type
...
- Version 1.1.1 (Deprecated): https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.single_level_bom_as_planned/1.1.1

#### Example: Aspect Model `SingleLevelBomAsPlanned` for a Catalog Part
...
Aspect model in GitHub: 
- Version 1.0.0: https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.part_site_information/1.0.0

#### Example: Aspect Model `PartSiteInformation` for a Component that is Produced at the Given Site
...
### PartSiteInformationAsPlanned (Deprecated)

The aspect provides site related information for a given as planned item (i.e. a part type or part instance that is uniquely identifiable within Catena-X via its Catena-X ID). A site is a delimited geographical area where a legal entity does business. In the "as planned" lifecycle context all potentially related sites are listed including all sites where e.g. production of this part (type) is planned.

Aspect model in GitHub: 
- Version 1.0.0 (Deprecated): https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.part_site_information_as_planned/1.0.0

#### Example: Aspect Model `PartSiteInformationAsPlanned` for a Component that is Produced at the Given Site
...
Aspect model in GitHub: 
- Version 1.0.2: https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.serial_part/1.0.2
- Version 1.0.1 (Deprecated): https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.serial_part/1.0.1

#### Example: Aspect Model `SerialPart` for a Vehicle
...
#### Example: Aspect Model `SerialPart` for a Serialized Part (Non-Vehicle)
...
- Version 2.0.0 (Deprecated): https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.batch/2.0.0

#### Example: Aspect Model `Batch` for a Batch of Raw Material
...
Aspect model in GitHub: 
- Version 1.0.1: https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.just_in_sequence_part/1.0.1
- Version 1.0.0 (Deprecated): https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.just_in_sequence_part/1.0.0

#### Example: Aspect Model `JustInSequencePart` for a non-serialized component
...
- Version 1.0.0 (Deprecated): https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.single_level_bom_as_built/1.0.0

#### Example: Aspect Model `SingleLevelBomAsBuilt` for a Serialized Part
...
#### Aspect Model `SingleLevelBomAsBuilt` for a Batch
