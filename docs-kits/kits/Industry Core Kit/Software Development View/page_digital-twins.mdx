...
##### Define submodel descriptors to represent mass data (like parquet files) reference
There are several ways to transfer mass data, such as parquet files. The main challenge in the transfer process lies in the large file sizes.
The following sections present the possible solutions for defining submodel descriptors to represent mass data.

###### Solution 1: Cloud2Cloud File transfer via S3 bucket with EDC AWS extension
**Introduction to File Transfer process in EDC**

1. `Provider` prepares aasx file with parquet file.
1. `Provider` uploads the aasx file to an S3 bucket.
...
3. `Provider` creates a shell with shell descriptors and the edc Asset with controlplane URL.
...
6. `Provider` retrieve the request and download the requested aasx file from bucket and upload it to the consumer bucket.
7. `Consumer` can download the file from their own bucket.
...
###### Solution 2: File transfer via AASX Server
If the file size is less than 100 GB, it can be transferred in AAX format via HTTPS. Therefore, the parquet file must be embedded in an AAX file and provided via the AASX server.

**Precondition**

A mass data like parquet file is interpreted as a submodel, and therefore, an AASX file always contains only one assetAdminstrationShell with exact one submodel.
![Industry Core kit massdata overview](@site/static/img/kits/industry-core/industry-core-kit-massdata-overview.svg)

**Definition**

The submodelDescriptor for this case can be defined as follows:
```json
{
   "idShort": "boschFleet",
   "id": "boschFleet",
   ...
   "submodelDescriptors": [
      {
         ...
         "endpoints": [
            {
               ...
               "protocolInformation": {
                  "href": "https://<provider-edc-dataplane-url>/<path>/packages/1>",
                  "endpointProtocol": "HTTP",
                  "endpointProtocolVersion": [
                     "1.1"
                  ],
         ...
         "description": [
            {
               "language": "en",
               "text": "submodel-descriptor for quality task which will be transferred via AAX File."
            }
         ]
      },
      {
         "idShort": "fleetClaimData",
         "id": "flettClaimData",
         "endpoints": [
            {
               "interface": "AASX-FILE-3.0",
               "protocolInformation": {
                  "href": "https://<provider-edc-dataplane-url>/<path>/packages/2",
                  "endpointProtocol": "HTTP",
                  "endpointProtocolVersion": [
                     "1.1"
                  ],
            ...
            "keys": [
               {
                  "type": "GlobalReference",
                  //TBD: New Model which map flatten hirarchy to model (like with "_" or ".")
                  "value": "urn:samm:io.catenax.fleet.claim_data:2.0.0#FlattenedClaimData"
               }
            ]
         },
         "description": [
            {
               "language": "en",
               "text": "submodel-descriptor for claim data which will be transferred via AAX File."
            }
         ]
      },
      {
         "idShort": "fleetDiagnosticData",
         "id": "fleetDiagnosticData",
         "endpoints": [
            {
               "interface": "AASX-FILE-3.0",
               "protocolInformation": {
                  "href": "https://<provider-edc-dataplane-url>/<path>/packages/3",
                  "endpointProtocol": "HTTP",
                  "endpointProtocolVersion": [
                     "1.1"
                  ],
            ...
            "keys": [
               {
                  "type": "GlobalReference",
                  //TBD: New Model which map flatten hirarchy to model (like with "_" or ".")
                  "value": "urn:samm:io.catenax.fleet.diagnostic_data:2.0.0#FlattenedDiagnosticData"
               }
            ]
         },
         "description": [
            {
               "language": "en",
               "text": "submodel-descriptor for diagnostic data which will be transferred via AAX File."
            }
         ]
      },
      {
         "idShort": "vehicleProductDescription",
         "id": "vehicleProductDescription",
         "endpoints": [
            {
               "interface": "AASX-FILE-3.0",
               "protocolInformation": {
                  "href": "https://<provider-edc-dataplane-url>/<path>/packages/4",
                  "endpointProtocol": "HTTP",
                  "endpointProtocolVersion": [
                     "1.1"
                  ],
            ...
            "keys": [
               {
                  "type": "GlobalReference",
                  //TBD: New Model which map flatten hirarchy to model (like with "_" or ".")
                  "value": "urn:samm:io.catenax.vehicle.product_description:2.0.0#FlattenedProductDescription"
               }
            ]
         },
         "description": [
            {
               "language": "en",
               "text": "submodel-descriptor for vehicle product description which will be transferred via AAX File."
            }
         ]
      },
      {
         "idShort": "qualityTaskAttachment",
         "id": "qualityTaskAttachment",
         "endpoints": [
            {
               "interface": "AASX-FILE-3.0",
               "protocolInformation": {
                  "href": "https://<provider-edc-dataplane-url>/<path>/packages/5",
                  "endpointProtocol": "HTTP",
                  "endpointProtocolVersion": [
                     "1.1"
                  ],
            ...
            "keys": [
               {
                  "type": "GlobalReference",
                  //TBD: New Model which map flatten hirarchy to model (like with "_" or ".")
                  "value": "urn:samm:io.catenax.quality_task_attachment:2.0.0#FlattenedQualityTaskAttachment"
               }
            ]
         },
         "description": [
            {
               "language": "en",
               "text": "submodel-descriptor for quality task attachment which will be transferred via AAX File."
            }
         ]
      }
   ]
...
Example AASX File for **qualityTask** structure can looks like:
```
bosch_quality_data.aasx
│   CX_release3_qax_testdata_qualitytask_v1.1.parquet
│───aasx
      └───data.xml
```

The reference inside of 'bosch_quality_data.aasx' -> 'data.xml' can look like:
```xml
<?xml version='1.0' encoding='UTF-8'?>
<aas:environment xmlns:aas="https://admin-shell.io/aas/3/0">
   <aas:assetAdministrationShells>
      <aas:assetAdministrationShell>
         <aas:idShort>boschFleet</aas:idShort>
         <aas:id>boschFleet</aas:id>
         <aas:assetInformation>
            <aas:assetKind>Instance</aas:assetKind>
            <aas:globalAssetId>global-asset-fleet</aas:globalAssetId>
         </aas:assetInformation>
         <aas:submodels>
            <aas:reference>
               ...
               <aas:keys>
                  <aas:key>
                     ...
                     <aas:value>qualityTask</aas:value>
                  </aas:key>
               </aas:keys>
            </aas:reference>
         </aas:submodels>
   ...
   <aas:submodels>
      <aas:submodel>
         <aas:category>qualityTask</aas:category>
         <aas:idShort>qualityTask</aas:idShort>
         <aas:id>qualityTask</aas:id>
         ...
         <aas:semanticId>
            ...
            <aas:keys>
               <aas:key>
                  ...
                  <aas:value>urn:samm:io.catenax.quality_task:2.0.0#FlattenedQualityTask</aas:value>
               </aas:key>
            </aas:keys>
         </aas:semanticId>
         <aas:submodelElements>
            <aas:file>
               ...
               <aas:idShort>quality_data_parquet</aas:idShort>
               <aas:semanticId>
                  <aas:type>ExternalReference</aas:type>
                  <aas:keys>
                     <aas:key>
               ...
               <aas:value>/CX_release3_qax_testdata_qualitytask_v1.1.parquet</aas:value>
               <aas:contentType>application/parquet</aas:contentType>
            </aas:file>
         </aas:submodelElements>
      </aas:submodel>
   </aas:submodels>
...
Example AASX File **claimData** structure can looks like:
```
bosch_claim_data.aasx
│   CX_release3_qax_testdata_claimData_v1.1.parquet
│───aasx
      └───data.xml
```

The reference inside of 'bosch_claim_data.aasx' -> 'data.xml' can look like:
...
<aas:environment xmlns:aas="https://admin-shell.io/aas/3/0">
   ...
   <aas:submodels>
      <aas:submodel>
         <aas:category>claimData</aas:category>
         <aas:idShort>claimData</aas:idShort>
         <aas:id>claimData</aas:id>
         <aas:kind>Instance</aas:kind>
         <aas:semanticId>
            <aas:type>ExternalReference</aas:type>
            <aas:keys>
               <aas:key>
                  <aas:type>GlobalReference</aas:type>
                  <aas:value>urn:samm:io.catenax.fleet.claim_data:2.0.0##FlattenedClaimData</aas:value>
               </aas:key>
            </aas:keys>
         </aas:semanticId>
         <aas:submodelElements>
            <aas:file>
               ...
               <aas:value>/CX_release3_qax_testdata_claimData_v1.1.parquet</aas:value>
               <aas:contentType>application/parquet</aas:contentType>
            </aas:file>
         </aas:submodelElements>
      </aas:submodel>
...
###### Solution 3: File transfer via [async.] AASX Server
Issue is created: See [github-issue 347](https://github.com/admin-shell-io/aas-specs-api/issues/347)
Status: In progress

###### Solution 4: File transfer via HTTPS
It is also possible to structure the data from the parquet file as JSON and deliver it via HTTPS in JSON format, which is currently the standard in Catena-X.
The submodelDescriptor for this case can be defined like:
```json
{
   ...
   "submodelDescriptors": [
      {
         ...
         "description": [
            {
               "language": "en",
               "text": "submodel-descriptor for vehicleProductDescription which will be transferred via HTTPS."
            }
         ]
      }
   ]
