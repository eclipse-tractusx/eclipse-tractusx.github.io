...
> :raised_hand: If the performance is still not satisfactory for the user, then next given approach can be used, where aasx file format can be used to transfer big files like parquet files.
