...
```json
{
    ...
    "protocolInformation": {
        ...
        "subprotocol": "DSP",
        "subprotocolBody": "dspEndpoint=https://edc.control.plane/api/v1/dsp;id=123",
...
- `subprotocolBody`: a semicolon-separated list of parameters used to negotiate the required contract agreement.
  - `dspEndpoint`: Base URL of the [catalog service](https://docs.internationaldataspaces.org/ids-knowledgebase/v/dataspace-protocol/catalog/catalog.binding.https#id-2.1-prerequisites) endpoint of the EDC control plane. The data consumer can use
...
- `subprotocolBody` must have the following format: `dspEndpoint=https://edc.control.plane/api/v1/dsp;id={edcAssetId}`
    ...
    "endpoints": [
      {
        ...
        "protocolInformation": {
          ...
          "endpointProtocolVersion": ["1.1"],
          "subprotocol": "DSP",
          "subprotocolBody": "dspEndpoint=https://edc.control.plane/api/v1/dsp;id=urn:uuid:75e98d67-e09e-4388-b2f6-ea0a0a642bfe-urn:uuid:7effd7f4-6353-4401-9547-c54b420a22a0",
          "subprotocolBodyEncoding": "plain",
          "securityAttributes": [ 
            { "type": "NONE", "key": "NONE", "value": "NONE" }
          ]
    ...
    "endpoints": [
      {
        ...
        "protocolInformation": {
          ...
          "endpointProtocolVersion": ["1.1"],
          "subprotocol": "DSP",
          "subprotocolBody": "dspEndpoint=https://edc.control.plane/api/v1/dsp;id=urn:uuid:1475f313-0a83-4e2b-b705-a100eebcb7d7",
          "subprotocolBodyEncoding": "plain",
          "securityAttributes": [ 
            { "type": "NONE", "key": "NONE", "value": "NONE" }
          ]
