...
All endpoints as well as the schema of the notification below are described in detail in the [Unique ID Push Open API specification](../../../../openApi/industrycore/unique-id-push.yaml).
