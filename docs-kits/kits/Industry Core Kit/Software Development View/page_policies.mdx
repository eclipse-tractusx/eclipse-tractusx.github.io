...
For general conventions about Usage Policies in Catena-X, check the [Connector Kit](../../../category/connector-kit).
...
Registry (as defined in the [DT Kit](../../../category/digital-twin-kit/)) is
