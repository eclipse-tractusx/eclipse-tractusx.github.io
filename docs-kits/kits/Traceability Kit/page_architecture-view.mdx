...
The following diagram shows a basic data processing flow how a comany's internal data can be transformed into a Traceability-compliant format. Implementations of data providers can deviate from this basic flow as it's just one way to do it. But it should give a basic idea what the essential steps are.
...
- Digtial Twin "PartInstance"
  ...
  - Aspect model ["SoftwareInformation"](<./Software Development View/page_data-provider_software-development-view.mdx#SoftwareInformation>)
