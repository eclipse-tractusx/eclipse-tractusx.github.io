...
- Digital Twin "PartInstance"
  ...
  - Aspect model ["SoftwareInformation"](../Traceability%20Kit/Software%20Development%20View/Data%20Provider%20Development%20View%20Traceability%20Kit#softwareinformation)
  - Aspect model ["CertificateSigningRequests"](../Traceability%20Kit/Software%20Development%20View/Data%20Provider%20Development%20View%20Traceability%20Kit#certificatesigningrequests)
...
> :raised_hand: Detailed Open API specifications for Blocking Notifications are available in the Development View. For  the current release, version 1.0.0 is optional and MUST be supported by every App provider from the next release. 

#### Block Notification State Model

State model that provides information about the block status of the individual parts within a block notification:

![Block State Model](./assets/block-notification-state-model.svg)

#### Block Notification State Model Interaction

The interaction of the status model is based on events that can be triggered by both the sender and the receiver.
