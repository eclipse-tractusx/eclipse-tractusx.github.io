...
Aspect model in GitHub:
- Version 1.0.0: https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main/io.catenax.special_characteristics/1.0.0

#### Example: Submodel `SpecialCharacteristics` for simple measurements
  ...
  "results": [
    {
      ...
      "simpleMeasurement": {
        "quantityValue": 20,
        "itemUnit": "unit:piece",
        "measurementTimestamp": "2022-02-05T12:00:54"
      },
      "simpleMeasurement": {
        "quantityValue": 20,
        "itemUnit": "unit:piece",
        "measurementTimestamp": "2022-02-06T17:55:54"
      }
    }
  ]
}
...
#### Example: Submodel `SpecialCharacteristics` for qualitative measurements
...
#### Example: Submodel `SpecialCharacteristics` for functional measurements
