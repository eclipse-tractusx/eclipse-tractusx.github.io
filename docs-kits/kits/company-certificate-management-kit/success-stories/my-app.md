...
![Company Certificate Management KIT Icon](@site/static/img/kits/company-certificate-management/ccm-kit-logo.svg) or [Application Logo]
...
```mermaid
graph LR
    A[External System] --> B[KIT Implementation]
