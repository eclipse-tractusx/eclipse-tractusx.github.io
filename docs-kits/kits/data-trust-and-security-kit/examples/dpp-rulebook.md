...
| 4.8.4   | footprintType(product carbon footprint)| Specifies type of environmental footprint measured, aiding in detailed sustainability analysis. | Yes       | Impact category types defined in sustainability guidelines.                                           | - In accordance with the provisions outlined in the Catena-X TfS PCF Verification Framework. - The Product Carbon Footprint (PCF) calculated in compliance with ISO 14067.                                         |           |
