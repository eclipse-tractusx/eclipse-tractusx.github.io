...
Compatible for **release 25.12**.

### Added

- Added api hub hyperlink for all services in development view of business partner kit with latest BPDM Application version 7.2.0.
