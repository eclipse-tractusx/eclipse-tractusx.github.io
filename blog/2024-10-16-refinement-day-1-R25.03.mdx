...
The blocker and overall teams session link can be found on our [open-meetings](/community/open-meetings) page. We look forward to seeing you all there!
...
As we look ahead to **[Refinement Day 2](/community/open-meetings)**, our focus will shift towards **dependency components**. It will be crucial to have those dependencies properly tagged with labels on the features.
