...
## Alignment Day for R26.06

The Alignment Day focuses on addressing open questions and unresolved dependencies from features planned for Release 26.06. This meeting is a possibility to connect and clarify open items before the main planning session.
...
During the session, if there is a common alignment among the participants, the feature milestone can be set to 26.06, meaning it will be developed in the upcoming release.
