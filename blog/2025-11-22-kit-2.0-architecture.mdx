...
<div style={{ display: 'flex', alignItems: 'flex-start', gap: '15px', margin: '30px 0' }}>
  ...
  <div>
    ...
    <p style={{ margin: '8px 0', fontSize: '14px' }}><strong>Key Characteristics:</strong></p>
...
<div style={{ display: 'flex', alignItems: 'flex-start', gap: '15px', margin: '30px 0' }}>
  ...
  <div>
    ...
    <p style={{ margin: '8px 0', fontSize: '14px' }}><strong>Requirements for Graduation:</strong></p>
    <ul style={{ margin: '4px 0', paddingLeft: '20px', fontSize: '14px' }}>
...
Every Thursday at 10:00 AM CET - 10:30 AM CET!

Check the [Eclipse Tractus-X Community Calendar](https://eclipse-tractusx.github.io/community/intro) for upcoming KIT Office Hours sessions and join us!
:::
