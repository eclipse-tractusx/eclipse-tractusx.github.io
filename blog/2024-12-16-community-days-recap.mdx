...
- **Catena-X and Tractus-X - The technical features of Catena-X and its implmentation with Tractus-X**
  - *Johannes Diemer, ARENA2036 e.V.*
- **Introduction to Industry Core - Building data chains for vehicles**
