...
export const kitsGallery = [
  {
    ...
    img: Business_Kit,
    pageRoute: "/docs-kits/kits/25.06/business-partner-kit/adoption-view",
  },
  {
    id: 2,
    name: 'Data Chain KIT',
    ...
    img: DataChain_Kit,
    pageRoute: "/docs-kits/kits/25.06/data-chain-kit/adoption-view",
  },
  {
    id: 3,
    name: 'Connector KIT',
    domain: 'Network Services',
    img: Connector_Kit,
    pageRoute: "/docs-kits/kits/25.06/connector-kit/adoption-view",
  },
  {
    id: 4,
    ...
    pageRoute: "/docs-kits/kits/25.06/traceability-kit/adoption-view",
  },
  {
    id: 5,
    ...
    pageRoute: "/docs-kits/kits/25.06/behaviour-twin-kit/overview",
  },
  {
    id: 6,
    ...
    domain: 'Industry Core',
    img: DigitalTwin,
    pageRoute: "/docs-kits/kits/25.06/digital-twin-kit/adoption-view",
  },
  {
    id: 7,
    name: 'Eco Pass KIT',
    ...
    img: EcoPass,
    pageRoute: "/docs-kits/kits/25.06/eco-pass-kit/adoption-view",
  },
  {
    id: 8,
    ...
    pageRoute: "/docs-kits/kits/25.06/online-simulation-kit/adoption-view",
  },
  {
    id: 9,
    ...
    domain: 'Quality',
    img: DDQM,
    pageRoute: "/docs-kits/kits/25.06/data-driven-quality-management-kit/adoption-view",
  },
  {
    id: 10,
    ...
    domain: 'Network Services',
    img: Agents_Kit,
    pageRoute: "/docs-kits/kits/25.06/knowledge-agents-kit/adoption-view/intro",
  },
  {
    id: 11,
    ...
    domain: 'Sustainability',
    img: Circularity_Kit,
    pageRoute: "/docs-kits/kits/25.06/circularity-kit/adoption-view",
  },
  {
    id: 12,
    ...
    pageRoute: "/docs-kits/kits/25.06/demand-and-capacity-management-kit/adoption-view/overview",
  },
  {
    id: 13,
    ...
    pageRoute: "/docs-kits/kits/25.06/modular-production-kit/adoption-view",
  },
  {
    id: 14,
    ...
    domain: 'Sustainability',
    img: PCF_Kit,
    pageRoute: "/docs-kits/kits/25.06/product-carbon-footprint-exchange-kit/adoption-view",
  },
  {
    id: 15,
    ...
    domain: 'Manufacturing',
    img: Maas_Kit,
    pageRoute: "/docs-kits/kits/25.06/manufacturing-as-a-service-kit/adoption-view",
  },
  {
    id: 16,
    ...
    domain: 'Sustainability',
    img: ESS_Kit,
    pageRoute: "/docs-kits/kits/25.06/environmental-and-social-standards-kit/adoption-view",
  },
  {
    id: 17,
    ...
    domain: 'Industry Core',
    img: Industry_Kit,
    pageRoute: "/docs-kits/kits/25.06/industry-core-kit/adoption-view",
  },
  {
    id: 18,
    name: 'Predictive Unit Real-Time Information Service KIT',
    domain: 'Supply Chain',
    pageRoute: "/docs-kits/kits/25.06/puris-kit/adoption-view",
    img: PURIS_Kit,
  },
  {
    id: 19,
    ...
    domain: 'Supply Chain',
    pageRoute: "/docs-kits/kits/25.06/supply-chain-disruption-notification-kit/adoption-view",
  ...
  },
  {
    ...
    domain: 'Engineering',
    pageRoute: "/docs-kits/kits/25.06/model-based-development-and-data-processing-kit/adoption-view",
    img: MBP_Kit,
  },
  {
    id: 21,
    name: 'Logistics KIT',
    domain: 'Supply Chain',
    pageRoute: "/docs-kits/kits/25.06/logistics-kit/adoption-view",
    img: Logistics_Kit,
  },
  {
    id: 22,
    ...
    domain: 'Network Services',
    pageRoute: "/docs-kits/kits/25.06/data-governance-kit/adoption-view",
  ...
  },
  {
    ...
    name: 'Customs KIT',
    domain: 'Supply Chain',
    pageRoute: "/docs-kits/kits/25.06/customs-kit/adoption-view",
    img: Customs_Kit,
  },
  {
    id: 24,
