...
export const CONTACTS = {
  ...
  THERESA_HILGER: { name: 'Theresa Hilger', title: 'Releasemanagemnt', email: 'theresa.hilger@catena-x.net', github: 'ther3sa', country: 'DE' },
};
...
export const meetings = [
  ...
  // New entries for R26.12 - Alignment Day and Open Planning
  {
      ...
      additionalLinks: [
          { title: 'Release Planning Board - Open Question', url: 'https://github.com/orgs/eclipse-tractusx/projects/26/views/43?filterQuery=-label%3Ametadata+label%3APrep-R26.12+label%3A%22open+question%22' },
          { title: 'Timeline', url: 'https://github.com/orgs/eclipse-tractusx/projects/26/views/35?filterQuery=label%3Ametadata+milestone%3A26.12' },
  ...
  },
  {
      ...
      matrixChatUrl: 'https://chat.eclipse.org/#/room/#tractusx-release-planning:matrix.eclipse.org',
      additionalLinks: [
          { title: 'Release Planning Board - Topic/Product', url: 'https://github.com/orgs/eclipse-tractusx/projects/26/views/28?filterQuery=-status%3ADone+has%3Atopic%2Fproduct+label%3A%22Prep-R26.12%22+status%3ABacklog' },
          { title: 'Timeline', url: 'https://github.com/orgs/eclipse-tractusx/projects/26/views/35?filterQuery=label%3Ametadata+milestone%3A26.12' },
          { title: 'News Blog', url: '/blog/release-planning-R26.12' },
