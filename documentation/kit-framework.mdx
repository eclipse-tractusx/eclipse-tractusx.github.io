...
:::warning
If there is a dataspace specific standard, please include it on the Dataspace Extensions Tab of from your Dataspace.
:::
...
The dataspace extensions are organized in a clear folder structure within each KIT:
...
Each dataspace folder contains only the specific extensions relevant to that dataspace, allowing for flexible and modular customization.
...
The dataspace specific standards should be added in this section and are hosted in the dataspace's standard library. 
