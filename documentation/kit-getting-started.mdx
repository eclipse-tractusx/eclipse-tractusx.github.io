...
|---------|---------|------|
| KIT Community Office Hours | Weekly alignment meetings | [Join Meeting](https://eclipse-tractusx.github.io/community/open-meetings) |
...
4. Update the [docusaurus.config.js](https://github.com/eclipse-tractusx/eclipse-tractusx.github.io/blob/61607621a41acc6b8bc219799433a231cf321b0d/docusaurus.config.js#L258-L382) file to include your new KIT at the navbar, search for `navbar: { items: [{type: 'dropdown', label: 'KITs', position: 'left', to: '/Kits', items: [...] }`
