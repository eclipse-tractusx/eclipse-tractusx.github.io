...
## <LightbulbIcon sx={{ fontSize: 24, color: '#f59e0b', marginRight: '8px', verticalAlign: 'middle' }} /> 1. Sandbox Level (MVP KIT)
...
<div style={{ display: 'flex', alignItems: 'stretch', gap: '20px', marginTop: '24px', flexWrap: 'wrap', justifyContent: 'center' }}>
  <div style={{
    ...
    <p style={{
      ...
      Why do we do this use case? / What is the scope? / What are the business context? / Which data I need?
    </p>
...
## <AssignmentIcon sx={{ fontSize: 24, color: '#72bd00ff', marginRight: '8px', verticalAlign: 'middle' }} /> 2. Incubating Level
...
### <EditIcon sx={{ fontSize: 20, color: '#f59e0b', marginRight: '6px', verticalAlign: 'middle' }} /> 2.1 Draft State
...
###  <DeveloperModeIcon sx={{ fontSize: 20, color: '#3b82f6', marginRight: '6px', verticalAlign: 'middle' }} /> 2.2 In Progress State
...
### <VisibilityIcon sx={{ fontSize: 20, color: '#8b5cf6', marginRight: '6px', verticalAlign: 'middle' }} /> 2.3 In Review State
...
## <SchoolIcon sx={{ fontSize: 24, color: '#8246e1ff', marginRight: '8px', verticalAlign: 'middle' }} /> 3. Graduated Level
