...
const sidebars = {
    kits: [
        ...
        },
        {
            ...
            link: {
                type: 'doc',
                id: 'kits/DCM-Kit/adoption-view/overview',
            },
            collapsed: true,
            items: [
                'kits/DCM-Kit/changelog', {
                    type: 'category',
                    label: 'Adoption View',
                    link: {
                        type: 'doc',
                    ...
                    items: [{
                            ...
                            items: [{
                                    type: 'autogenerated',
                                    dirName: 'kits/DCM-Kit/adoption-view/use-case'
                                }
                            ]
                        },
                        'kits/DCM-Kit/adoption-view/onboarding',
                        'kits/DCM-Kit/adoption-view/qna',
                        'kits/DCM-Kit/adoption-view/foss-app',
                    ]
                }, {
                    type: 'category',
                    label: 'Development View',
                    link: {
                        type: 'doc',
                        id: 'kits/DCM-Kit/development-view/overview',
                    },
                    items: [
                        'kits/DCM-Kit/development-view/model-WeekBasedMaterialDemand',
                        'kits/DCM-Kit/development-view/model-WeekBasedCapacityGroup',
                    ...
                    link: {
                        type: 'doc',
                        id: 'kits/DCM-Kit/architecture-view/overview',
                    },
                    items: [
                        'kits/DCM-Kit/architecture-view/dependencies',
                    ]
                },
                'kits/DCM-Kit/operation-view',
            ]
        },
        {
            type: 'category',
            ...
            items: [
                {
                    'kits/Logistics Kit/Adoption View Logistics Kit',
                    {
                        ...
                        items: [
                            {
                                'kits/Logistics Kit/customs/Adoption View Customs Kit',
                            }
                        ]
                    }
                },
