...
const sidebars = {
  kits: [
    ...
    {
      type: 'category',
      label: 'Company Certificate Management KIT',
      link: { type: 'generated-index', },
      collapsed: true,
      items: [
        {
          type: 'autogenerated',
          dirName: 'kits/company-certificate-management-kit',
        },
     ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: {
              type: 'doc',
              id: 'kits/connector-kit/software-development-view/architecture'
          },
          items: [
              {
                  type: 'autogenerated',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              type: 'autogenerated',
              dirName: 'kits/eco-pass-kit/documentation'
            }
          ]
        },
      ],
