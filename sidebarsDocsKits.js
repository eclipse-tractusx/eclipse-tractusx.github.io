...
// Keep this aligned with the docs-kits plugin path configured in docusaurus.config.js.
...
// dirName is always a docs-kits-relative path, matching Docusaurus autogenerated sidebar resolution.
// This is evaluated once when the sidebar module loads, which is sufficient for build-time sidebar generation.
...
const sidebars = {
  kits: [
    ...
    {
      type: 'category',
      label: 'Autonomous Operation KIT',
      link: {
          type: 'doc',
          id: 'kits/autonomous-operation-kit/adoption-view/adoption-view',
      },
      collapsed: true,
      items: [
          'kits/autonomous-operation-kit/changelog',
          {
              type: 'category',
              label: 'Adoption View',
              link: {
              ...
              items: [
                  {
                      type: 'autogenerated',
                      dirName: 'kits/autonomous-operation-kit/adoption-view',
                  },
              ]
          },
          {
              ...
              link: {
                  type: 'doc',
                  id: 'kits/autonomous-operation-kit/development-view/architecture-semantic-models'
              },
              items: [
                  {
                      type: 'autogenerated',
                      dirName: 'kits/autonomous-operation-kit/development-view',
                  },
              ]
          }
      ]
    ...
    createGeneratedIndexKitCategory(
      'Environmental and Social Standards KIT',
      'kits/environmental-and-social-standards-kit'
    ),
    ...createOptionalGeneratedIndexKitCategory('eSDScom KIT', 'kits/esdscom-kit'),
    createGeneratedIndexKitCategory('Geometry KIT', 'kits/geometry-kit'),
    {
      type: 'category',
    ...
    {
      type: 'category',
      label: 'PCF Data Acquisition KIT',
      link: {type: 'generated-index'},
      collapsed: true,
      items: [
        {
          type: 'autogenerated',
          dirName: 'kits/pcf-data-acquisition-kit',
        },
      ],
    },
    {
