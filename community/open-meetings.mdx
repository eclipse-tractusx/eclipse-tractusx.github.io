...
<MeetingInfo title="Refinement Phase - Release 24.12"
             ...
             description="This phase serves as preparation for Open Planning. During this time, the necessary people/groups can come together and work on the future features. Feature authors take care of organising appointments and communicating with the relevant contacts themselves. The Teams Session link can be used. Be aware: The link and the shared content is available to everyone."
             contact="stephan.bauer@catena-x.net"
