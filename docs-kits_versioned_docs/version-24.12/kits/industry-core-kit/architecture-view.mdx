...
- All users have **completed onboarding** to the Catena-X network. This includes:
    ...
    - Data Providers operate a Digital Twin Registry according to
      the [Digital Twin KIT](../digital-twin-kit/adoption-view) and the
...
- [Digital Twin KIT - Registration at EDC](../digital-twin-kit/software-development-view) with details about versioning of EDC assets (for submodels as well as for Notification assets) including examples.
