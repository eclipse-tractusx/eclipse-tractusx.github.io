...
<div style={{"marginBottom":"2rem"}}><a href="https://raw.githubusercontent.com/eclipse-tractusx/item-relationship-service/4.5.2/docs/src/api/irs-api.yaml" id={"swagger"} style={{"marginBottom":"1rem"}}>Swagger UI</a></div>
