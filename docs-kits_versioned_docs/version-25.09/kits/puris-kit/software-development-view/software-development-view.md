...
the [Policies in Catena-X of the Connector KIT](https://eclipse-tractusx.github.io/docs-kits/connector-kit/adoption-view_policies_cx/).
...
the [Digital Twin KIT](https://eclipse-tractusx.github.io/docs-kits/next/kits/digital-twin-kit/software-development-view/interaction-patterns)
and relies on
the [Part Type Twin definitions of the Industry Core KIT](https://eclipse-tractusx.github.io/docs-kits/industry-core-kit/software-development-view/Digital%20Twins%20Development%20View%20Industry%20Core%20Kit).
...
see [all PURIS semantic models](https://eclipse-tractusx.github.io/docs-kits/puris-kit/adoption-view#semantic-models)),
