...
For guidance on how the acquired data is subsequently exchanged and reported, refer to the **[PCF Exchange KIT](../../product-carbon-footprint-exchange-kit/adoption-view)** . An overarching description of the end-to-end PCF process and methodology can be found in the **[Catena-X Rulebook](https://catenax-ev.github.io/assets/files/CX-NFR-PCF-Rulebook_v.3.0-04874a80a6d27511df06e07ae3049278.pdf)** and in the [Manufacturing-X PCF Guidelines](https://mx-guidanceboard.org/wp-content/uploads/MX-PCF-Guideline_V1_0.pdf). Additional guidance on PCF calculations can be found in the _Factory-X PCF Guidance Document_.
