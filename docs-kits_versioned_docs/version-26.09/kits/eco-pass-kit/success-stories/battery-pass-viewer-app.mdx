...
import Logo from "../resources/success-stories/BatteryLogo.png";

<div className={styles.logoContainer}>
  <div className={styles.logoBackground}>
    <img className={styles.logoImage} src={Logo} />
    <p className={styles.logoName}><strong>Battery Pass Application</strong></p>
  </div>
</div>
...
[![BatteryPass Viewer App - General Information](../resources/success-stories/battery-pass-viewer-app1.png)](../resources/success-stories/battery-pass-viewer-app1.png)

## Cell Information Display

Other Important information is displayed like hazard materials and critical raw materials. This information allows the user to know and act accordingly depending on the information he has available in the Application. Increasing the safety of the worker which is using the application.

[![BatteryPass Viewer App - Cell Chemistry](../resources/success-stories/battery-pass-viewer-app2.png)](../resources/success-stories/battery-pass-viewer-app2.png)
...
[![Digital Product Pass](../resources/success-stories/DigitalProductPass_DEMO_View1_Module.png)](../resources/success-stories/DigitalProductPass_DEMO_View1_Module.png)
...
[![Drill Down Components](../resources/success-stories/DigitalProductPass_DEMO_View2_Components_Module.png)](../resources/success-stories/DigitalProductPass_DEMO_View2_Components_Module.png)
