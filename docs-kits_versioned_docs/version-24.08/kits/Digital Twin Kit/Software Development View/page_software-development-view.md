...
- In some circumstances (such as the [PCF Kit](../../product-carbon-footprint-exchange-kit/software-development-view/page_software-development-view.md#payload-for-requesting-pcf-sub-model))
