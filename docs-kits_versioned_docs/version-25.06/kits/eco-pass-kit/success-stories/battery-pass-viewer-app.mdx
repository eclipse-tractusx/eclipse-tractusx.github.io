...
Other Important information is displayed like hazard materials and critial raw materials. This information allows the user to know and act accordingly depending on the information he has available in the Application. Increasing the safety of the worker which is using the application.
