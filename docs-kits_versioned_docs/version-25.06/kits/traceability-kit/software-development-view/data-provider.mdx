...
Access policies like the BPN access policy and Usage Policies / Contract Policies are described in the [policy section of the Industry Core KIT](../../industry-core-kit/software-development-view/policies.mdx).
