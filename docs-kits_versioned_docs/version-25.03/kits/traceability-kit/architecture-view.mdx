...
- Digital Twin "PartInstance"
  - Aspect model ["TractionBatteryCode"](https://eclipse-tractusx.github.io/docs-kits/kits/traceability-kit/software-development-view/data-provider#tractionbatterycode)
  - Aspect model ["SoftwareInformation"](https://eclipse-tractusx.github.io/docs-kits/kits/traceability-kit/software-development-view/data-provider#softwareinformation)
  - Aspect model ["CertificateSigningRequests"](https://eclipse-tractusx.github.io/docs-kits/kits/traceability-kit/software-development-view/data-provider#certificatesigningrequests)

Details about these aspect models, i.e., the SAMM data model as well as example data, can be found in the [Developer View](../traceability-kit/software-development-view/data-provider).
