...
- [Digital Twin KIT - Registration at EDC](../digital-twin-kit/software-development-view/software-development-view.md#registration-at-edc) with details about versioning of EDC assets (for submodels as well as for Notification assets) including examples.
