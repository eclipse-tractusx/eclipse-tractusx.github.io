...
The Unique ID Push notifications have a standardized format. Schemas of these notifications are described in detail in the Unique ID Push Open API specification. The standardized version of this API is [2.0.0](https://eclipse-tractusx.github.io/api-hub/eclipse-tractusx.github.io/2.0.0/unique-id-push.yaml). Version [2.1.0](https://eclipse-tractusx.github.io/api-hub/eclipse-tractusx.github.io/2.1.0/unique-id-push_2-1-0.yaml) is not (yet) standardized, but backwards compatible, and extends v2.0.0 with the Connect-to-Child feature.
...
Properties `http://purl.org/dc/terms/type` and `https://w3id.org/catenax/ontology/common#version` are used to classify the asset and are explained in the [Digital Twin KIT](https://eclipse-tractusx.github.io/docs-kits/kits/digital-twin-kit/software-development-view#registration-at-edc) in more detail.
...
The receiver must setup a backend data service that provides an HTTP Endpoint for notifications. All endpoints are described in detail in the Unique ID Push Open API specification. The standardized version of this API is [2.0.0](https://eclipse-tractusx.github.io/api-hub/eclipse-tractusx.github.io/2.0.0/unique-id-push.yaml). Version [2.1.0](https://eclipse-tractusx.github.io/api-hub/eclipse-tractusx.github.io/2.1.0/unique-id-push_2-1-0.yaml) is not (yet) standardized, but backwards compatible, and extends v2.0.0 with the Connect-to-Child feature.
