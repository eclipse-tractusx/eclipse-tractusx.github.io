...
### Added
 - **Adoption View:**
   - new aspect model / use case "ZeroKmFailure"

 - **Development View:**
   - **Data Provider:**
       - **Aspect Models:**
         - Added the new ZeroKmFailure model to the aspect model overview
       - **ZeroKmFailure:**
         - Added a new section to describe and reference the aspect model for ZeroKmFailure including JSON examples

- **Architecture View:**
   - new aspect model "ZeroKmFailure"

### Changed
- **Architecture View:**
   - listing of aspect models to existing DTs
...
### Added
 - **Adoption View:**
   - Introduced the new Digital Twin "qualityTask"

 - **Architecture View:**
   - Added the new Digital Twin "qualityTask"

### Changed
- **Architecture View:**
  - Adapted process for sending, receiving and updating Block Notifications including Problem ID to refernce the Block Notification to the inital problem, the Block Notification was requested for

- **Development View:**
  - **App Provider:**
    - New version (v2.0.0) for Block Notification was developed including the field ProblemID
...
- Changed:
    - updated referenced SpecialCharacteristics aspect model to correct version
...
- **Architecture View:**
  ...
  - **Runtime View:**
    - Added references to the corresponding sections of the HTTP Endpoints for the notifications
...
- **Development View:**
  ...
  - Setting the visibility of entries in a digital twin's specified asset IDs is now mandatory to ensure need-know
