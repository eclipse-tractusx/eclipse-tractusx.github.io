...
Data provisioning of Traceability is built on the data provisioning of the [Industry Core KIT](../industry-core-kit/architecture-view), i.e., Traceability extends the digital twins PartType, PartInstance and qualityTask with additional aspect models:

- Digital Twin "PartType"
  - N/A
- Digital Twin "PartInstance"
  - Aspect model ["TractionBatteryCode"](https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main)
...
- Digital Twin "qualityTask"
  - Aspect model ["ZeroKmFailure"](https://github.com/eclipse-tractusx/sldt-semantic-models/tree/main)
  - Aspect models out of several use cases, like data driven quality, logistics etc.
