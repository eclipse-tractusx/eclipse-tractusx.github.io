...
![Supply network](./resources/business-architecture-network.svg)
...
|-|-|-|-|-|
|DCM Business Logic|[CX-0128 Demand and Capacity Management Data Exchange][StandardLibrary]|2.3.0|5|Focuses on a common understanding of the DCM processes among participants.|
|DCM Aspect Models|[CX-0128 Demand and Capacity Management Data Exchange][StandardLibrary]|2.3.0|3|Aligns the structure of the shared information and enables the adoption of the core business logic without misinterpretation.|
|DCM APIs|[CX-0128 Demand and Capacity Management Data Exchange][StandardLibrary]|2.3.0|4|Ensures that data is provided and consumed properly as well as identically interpreted across companies.|
